...
class graph {
    ...
    void id_connected_component(subset& vertices, long int ivertex, long int component, long int * ids);
...
public:
    ...
    void get_incident_vertices(long int ivertex, subset& vertices);
    long int connected_components(subset& vertices, long int * ids);
    long int connected_components(subset& vertices, vector<clique_info> * comps);
