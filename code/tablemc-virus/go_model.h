...
public:
    ...
    void create_contact_map(int itype, fragmenttype * ifragtype, int jtype, fragmenttype * jfragtype,  int nfrag,  fragmentinfo * fraginfo, double * nativecoords);
    void set_parameters(go_model_params * params);
    double energy(int pbc, double halfboxsize, double boxsize, go_model_params * params,  fragmenttype * ifragtype, double * icoords, fragmenttype * jfragtype, double * jcoords); //need actual parameters
